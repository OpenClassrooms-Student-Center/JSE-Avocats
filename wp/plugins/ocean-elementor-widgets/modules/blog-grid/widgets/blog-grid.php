									...
									if ( 'yes' == $comments
										...
										<ul class="oew-grid-meta<?php echo esc_attr( $meta_class ); ?> clr">
											...
											<?php if ( 'yes' == $comments && comments_open() && ! post_password_required() ) { ?>
												<li class="meta-comments"><i class="<?php echo $theme_icons[ 'comment' ][ $icon_t ]; ?>"></i><?php comments_popup_link( esc_html__( '0 Comments', 'ocean-elementor-widgets' ), esc_html__( '1 Comment',  'ocean-elementor-widgets' ), esc_html__( '% Comments', 'ocean-elementor-widgets' ), 'comments-link' ); ?></li>
											<?php } ?>

											<?php if ( 'yes' == $cat ) { ?>
												<li class="meta-cat"><i class="<?php echo $theme_icons[ 'category' ][ $icon_t ]; ?>"></i><?php the_category( ' / ', get_the_ID() ); ?></li>
											<?php } ?>
